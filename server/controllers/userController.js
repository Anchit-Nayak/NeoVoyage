...
const verifyOtp = async(req,res,next) => {
  try{
    ...
    res.status(200).json({message:"OTP Verified",_id:user._id, email:user.email,accessToken,refreshToken,role:user.role})
  } catch(err){
    console.log(err)
    res.status(500).send("Internal Server Error.")
  }
...
module.exports = { login, signupTourist, signupBusiness, verifyOtp, resendOtp };